                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <form method="post"
                                  action="{{route('productAttributes.update', $product->productAttribute)}}">
                                @csrf
                                @method('patch')
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                               ...
                               focus:border-indigo-500 focus:z-10 sm:text-sm"
                                               value="{{$product->productAttribute->key}}">
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                               ...
                               placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500
                               focus:border-indigo-500 focus:z-10 sm:text-sm"
                                               value="{{$product->productAttribute->value}}">
                                    </div>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900 ">
                                            <form method="post"
                                                  action="{{route('productAttributes.destroy', $product->productAttribute)}}">
                                                @csrf
                                                @method('delete')
                                                <button class="text-indigo-600 hover:text-indigo-900"
                                                        onclick="return confirm('Are you really' +
                                                            ' want to delete product attribute')">Delete
                                                </button>
                                            </form>
                                        </div>
                                    </div>
